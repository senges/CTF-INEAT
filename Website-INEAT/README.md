...
Globalement pour résumer, quand un hash débute par "0e" et que - pour une raison obscule - on le compare à "0", C'est la merde. Le test passera systématiquement et notre comparaison devient innutile. Il nous faut donc trouver une chaine qui preduit un MD5 qui :
* Commence par "0e"
* Contient "hello"
